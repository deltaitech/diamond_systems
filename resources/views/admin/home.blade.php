...
{{--        </div>--}}
        ...
        <div class="row">
            <div class="col-12 d-flex align-items-center justify-content-center">
                <img src="{{settings()->logo}}" class="img-fluid rounded" style="width: 300px;" alt="logo">
            </div>
            ...
            <div class="col-xl-4">
                <div class="card card-custom card-stretch gutter-b wave wave-primary wave-animate-slow">
                    <div class="card-body">
                        ...
                        <span class="card-title font-weight-bolder text-dark-75 font-size-h1 mb-0 mt-6 d-block">{{ \App\Models\ContactUs::count() }}</span>
                        <span class="font-weight-bold font-size-sm"><a href="{{route('contact_requests.index')}}">{{__('words.contact_requests')}}</a></span>
                    </div>
                </div>
            </div>
            @endpermission
